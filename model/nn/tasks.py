    ...
    base_modules = frozenset(
        {
            ...
            C2fCIB,
            A2C2f,
            PSConv,GSConvE,C2PSA_EPGO,SRFD,C2PSA_MALA,C2TSSA,FeaturePyramidSharedConv,GCConv,SPPF_ScaleAware,DAC,C3k2_MambaOut,
            DilatedConv,CDC,SPDConv,ODConv,WTConv,SCConv,YOLO_DSConv
    ...
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2fCIB,
            C2PSA,
            A2C2f,C2PSA_EPGO,C2PSA_MALA,C2TSSA,C3k2_MambaOut
        }
    )
